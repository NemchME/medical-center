...
export const MOCK_CENTERS: ClinicCenter[] = [
  ...
  },
  {
    ...
    email: "plekhanovskaya@medicina.ru",
  },
];
...
export const MOCK_PATIENTS: Patient[] = [
  ...
  },
  {
    ...
    gender: "female",
    address: "г. Воронеж, пр. Революции, д. 25",
  },
  {
    id: 3,
    ...
    gender: "male",
    address: "г. Воронеж, ул. Кольцовская, д. 5",
  },
  {
    id: 4,
    ...
    gender: "female",
    address: "г. Воронеж, ул. 20-летия Октября, д. 88",
  },
  {
    id: 5,
    ...
    gender: "male",
    address: "г. Воронеж, ул. Ворошилова, д. 32",
  },
];
...
export const MOCK_APPOINTMENTS: Appointment[] = [
  ...
  },
  {
    ...
    visit: {
      id: 1,
      appointmentId: 5,
      complaints: "Боль в правом подреберье",
      diagnosis: "Желчнокаменная болезнь",
      examination: "При пальпации — болезненность в правом подреберье",
      notes: "Направлен на УЗИ",
      closedAt: dayAt(-3, 16, 0),
      prescriptions: [
        {
          id: 1,
          visitId: 1,
          text: "Урсодезоксихолевая кислота 250мг 2р/д — 30 дней",
          status: "active",
          createdAt: dayAt(-3, 16, 0),
        },
        {
          id: 2,
          visitId: 1,
  ...
  },
  {
    ...
    visit: {
      id: 2,
      appointmentId: 6,
      complaints: "Сыпь на руках",
      diagnosis: "Контактный дерматит",
      examination: "Эритематозные высыпания на кистях рук",
      notes: "",
      closedAt: dayAt(-1, 12, 30),
      prescriptions: [
        {
          id: 3,
          visitId: 2,
          text: "Мометазон крем 0.1% — 2р/д 14 дней",
          status: "active",
          createdAt: dayAt(-1, 12, 30),
        },
      ],
    },
  },
  ...
  },
  {
    ...
    doctorId: 6,
    centerId: 3,
    startAt: dayAt(-2, 9, 30),
    durationMin: 30,
    status: "cancelled",
    createdAt: day(-4),
    sourceChannel: "web",
    patient: MOCK_PATIENTS[2],
    doctor: MOCK_DOCTORS[5],
    center: MOCK_CENTERS[2],
  },
];
...
export const MOCK_SERVICES: Service[] = [
  {
    ...
    description: "Первичный осмотр, сбор анамнеза, назначение обследований",
    durationMinDefault: 30,
    prices: [{ id: 1, centerId: 1, price: 2500, currency: "RUB" }],
  },
  {
    id: 2,
    code: "CONSULT-CARD",
    name: "Консультация кардиолога",
    description: "Осмотр, ЭКГ, интерпретация результатов",
    durationMinDefault: 30,
    prices: [{ id: 2, centerId: 1, price: 3500, currency: "RUB" }],
  },
  {
    id: 3,
    code: "CONSULT-NEUR",
    name: "Консультация невролога",
    description: "Неврологический осмотр, оценка рефлексов",
    durationMinDefault: 45,
    prices: [{ id: 3, centerId: 2, price: 3200, currency: "RUB" }],
  },
  {
    id: 4,
    code: "CONSULT-SURG",
    name: "Консультация хирурга",
    description: "Осмотр, определение необходимости оперативного лечения",
    durationMinDefault: 60,
    prices: [{ id: 4, centerId: 2, price: 4000, currency: "RUB" }],
  },
  {
    id: 5,
    code: "CONSULT-DERM",
    name: "Консультация дерматолога",
    description: "Дерматоскопия, осмотр кожных покровов",
    durationMinDefault: 30,
    prices: [{ id: 5, centerId: 3, price: 2800, currency: "RUB" }],
  },
  {
    id: 6,
    code: "CONSULT-OPHT",
    ...
    durationMinDefault: 30,
    prices: [{ id: 6, centerId: 3, price: 3000, currency: "RUB" }],
  },
  {
    id: 7,
    code: "ECG",
    ...
    durationMinDefault: 15,
    prices: [{ id: 7, centerId: 1, price: 1200, currency: "RUB" }],
  },
  {
    id: 8,
    code: "UZI-ABD",
    ...
    durationMinDefault: 30,
    prices: [{ id: 8, centerId: 1, price: 2000, currency: "RUB" }],
  },
];
...
export const MOCK_TESTS: LabTest[] = [
  {
    ...
    preparation: "Натощак, 8-12 часов голодания",
    prices: [{ id: 1, centerId: 1, price: 800, currency: "RUB" }],
  },
  {
    id: 2,
    code: "BMP",
    name: "Биохимия крови (базовая)",
    description: "Глюкоза, креатинин, АЛТ, АСТ, билирубин, общий белок",
    sampleType: "Кровь из вены",
    preparation: "Натощак, исключить жирную пищу за 24ч",
    prices: [{ id: 2, centerId: 1, price: 1500, currency: "RUB" }],
  },
  {
    id: 3,
    code: "UA",
    name: "Общий анализ мочи",
    description: "Физико-химические свойства, микроскопия осадка",
    sampleType: "Моча",
    preparation: "Утренняя средняя порция",
    prices: [{ id: 3, centerId: 1, price: 500, currency: "RUB" }],
  },
  {
    id: 4,
    code: "TSH",
    ...
    sampleType: "Кровь из вены",
    preparation: "Натощак, до 10:00",
    prices: [{ id: 4, centerId: 2, price: 700, currency: "RUB" }],
  },
  {
    id: 5,
    code: "LIPID",
    name: "Липидный профиль",
    description: "Холестерин, ЛПВП, ЛПНП, триглицериды",
    sampleType: "Кровь из вены",
    preparation: "Натощак, 12 часов голодания",
    prices: [{ id: 5, centerId: 2, price: 1200, currency: "RUB" }],
  },
  {
    id: 6,
    code: "HBA1C",
    ...
    prices: [{ id: 6, centerId: 3, price: 900, currency: "RUB" }],
  },
];
